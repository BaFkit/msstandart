...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query(value = "select o from Order o where o.status=:statusOrderNew or o.status=:statusOrderInWork or o.status=:statusOrderReady order by o.createdAt desc")
    Page<Order> findAllWhereStatusIsNot(Pageable page, StatusOrder statusOrderNew, StatusOrder statusOrderInWork, StatusOrder statusOrderReady);
}
